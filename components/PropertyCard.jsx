      ...
      <div className='rounded-xl shadow-md relative'>
        ...
        <div className='p-4'>
          <div className='text-left md:text-center lg:text-left mb-6'>
            <div className='text-gray-600 truncate'>{property.type}</div>
          ...
          <div className='flex justify-center gap-2 text-green-900 text-sm mb-4 truncate'>
          <p><FaMoneyBill className='inline' /></p>
